...
## I Use
[![My Skills](https://skillicons.dev/icons?i=python,javascript,typescript,go,fastapi,react,svelte,mysql,mongodb,postgresql,redis,aws,gcp,docker,jupyter,pytorch,tensorflow,git,rust,cpp&perline=10)](https://skillicons.dev)
